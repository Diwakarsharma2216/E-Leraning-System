...
import { StarRating } from "./Course";
const Review = () => {
  let arr=[1,2]
  return (

    <div className=" bg-gray-900 h-fit pt-15 pb-5 ">
   <h2 className="md:text-2xl text-center justify-center xs:text-xl lg:text-3xl xl:text-4xl text-yellow-100 pt-10">
   ...
   {arr.map((el)=>
<article className="w-5/6 m-auto pt-5 pb-5">
    <div className="flex items-center mb-4 space-x-4">
        <img className="w-10 h-10 rounded-full" src="https://assets.stickpng.com/images/585e4bcdcb11b227491c3396.png" alt="" />
        <div className="space-y-1 font-medium text-yellow-100">
